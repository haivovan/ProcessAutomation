...
{
    public class RegisterAccount_AZSite : IRegisterAccount
    {
        ...
        public RegisterAccount_AZSite(RegisterAccountModel data)
        {
            this.data = data;
        }
                        ...
                        case "AddUser":
                            ...
                            if (!webLayout.Url.ToString().Contains(agencies_URL))
                            {
                                ...
                                SendNotificationForError(
                                    ...
                                    $"{Constant.NAPAZ.ToUpper()} : user { data.WebId + data.IdNumber } lỗi {errorFromCreation}");
                            }
                            else
                            {
                                SendNotificationForError(
                                    $"Tạo user thành công cho web {Constant.NAPAZ.ToUpper()}",
                                    ...
                                    $"Tên web: {Constant.NAPAZ.ToUpper()} ({data.WebId})" + Environment.NewLine +
                                    ...
                                    $"(YÊU CẦU ĐỔI MẬT KHẨU VÀ CÀI OTP ĐỂ BẢO MẬT TÀI KHOẢN)" + Environment.NewLine +
