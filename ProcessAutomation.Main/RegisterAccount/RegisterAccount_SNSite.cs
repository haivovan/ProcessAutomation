...
{
    public class RegisterAccount_SNSite : IRegisterAccount
    {
        ...
        public RegisterAccount_SNSite(RegisterAccountModel data)
        {
            this.data = data;
        }
                        ...
                        case "AddUser":
                            ...
                            if (!webLayout.Url.ToString().Contains(agencies_URL))
                            {
                                ...
                                SendNotificationForError(
                                    ...
                                    $"{Constant.SIEUNHANH.ToUpper()} : user { data.WebId + data.IdNumber } lỗi {errorFromCreation}");
                            }
                            else
                            {
                                SendNotificationForError(
                                    $"Tạo user thành công cho web {Constant.SIEUNHANH.ToUpper()}",
                                    ...
                                    $"Tên web: {Constant.SIEUNHANH.ToUpper()} ({data.WebId})" + Environment.NewLine +
