...
{
    public class BKSite : IAutomationPayIn
    {
        ...
        private const string url = "https://khoaisan.net/";
        ...
        public BKSite(List<Message> data, GeckoWebBrowser web)
        {
            this.data = data;
            this.webLayout = web;
        }
        ...
        private void Login(AdminAccount adminAccount)
        {
            ...
            GeckoHtmlElement btnLogin = (GeckoHtmlElement)htmlLogin.GetElementById("loginForm");
        ...
        private AccountData SearchUser()
        {
            ...
            if (userAccount == null || string.IsNullOrEmpty(userAccount.BK))
                return null;
            return userAccount;
        }
        ...
        private void SearchUserClick(AccountData userAccount)
        {
            ...
            userFilter.SetAttribute("value", userAccount.BK);
        ...
        private void PayIn()
        {
            ...
            var bonus = adminSetting.Query
                    ...
                    .Where(x => x.Key == Constant.BANHKEO).FirstOrDefault().Value;
