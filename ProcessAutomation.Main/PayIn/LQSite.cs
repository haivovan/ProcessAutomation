                        ...
                        case "PayIn":
                            ...
                            if (!webLayout.Url.ToString().Contains(agencies_URL))
                            {
                                ...
                                SendNotificationForError(
                                    ...
                                    $"{Constant.LANQUEPHUONG.ToUpper()} : Lỗi + { helper.GetMoneyFormat(currentMessage.Money) } { currentMessage.Web }{ currentMessage.Account }");
                            }
                            else
                            {
                                ...
                                SendNotificationForError(
                                    ...
                                    $"{Constant.LANQUEPHUONG.ToUpper()} : Đã + { helper.GetMoneyFormat(currentMessage.Money) } { currentMessage.Web }{ currentMessage.Account }, SD: { helper.GetMoneyFormat(moneyAfterPay.ToString()) } ");
                            }
