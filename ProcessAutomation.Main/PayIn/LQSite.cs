    ...
    public class LQSite : IAutomationPayIn
    {
                        ...
                        case "PayIn":
                            ...
                            if (!webLayout.Url.ToString().Contains(agencies_URL))
                            {
                                ...
                                SendNotificationForError(
                                    ...
                                    $"{Constant.LANQUEPHUONG.ToUpper()} : Lỗi + { currentMessage.Money } { currentMessage.Web }{ currentMessage.Account }");
                            }
                            else
                            {
                                SaveRecord();
                                SendNotificationForError(
                                    ...
                                    $"{Constant.LANQUEPHUONG.ToUpper()} : Đã + { currentMessage.Money } { currentMessage.Web }{ currentMessage.Account }");
                            }
        ...
        private void PayIn()
        {
            ...
            var bonus = adminSetting.Query
                   ...
                   .Where(x => x.Name == Constant.LANQUEPHUONG).FirstOrDefault().Value;
